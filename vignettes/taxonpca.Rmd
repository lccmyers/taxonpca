...
Let's take a look at the PCA functions we created in our package `taxonpca` - this package allows analysis at different taxonomic levels using PCA. First, we need to load in the custom dataset included with the package, which includes 13 numerical variables with data on 213 primates.
